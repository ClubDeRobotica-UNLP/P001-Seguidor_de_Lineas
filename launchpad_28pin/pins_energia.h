...
*/
 ...
 /* lo comente y agregue lo de abajo
...
const uint32_t digital_pin_to_analog_in[] = {
		...
		4,  	  		/* 6,  port P1.4 */
		5, 		   		/* 7,  port P1.5 */
		NOT_ON_ADC,	    /* 8,  port P3.1 */
		NOT_ON_ADC,     /* 9,  port P3.0 */
		NOT_ON_ADC,     /* 10,  port P2.0 */
		NOT_ON_ADC,    	/* 11,  port P2.1 */
		NOT_ON_ADC,   	/* 12,  port P2.2 */
		NOT_ON_ADC,     /* 13,  port P3.2 */
		NOT_ON_ADC,    	/* 14,  port P3.3 */
		NOT_ON_ADC,  	/* 15,  port P3.4 */
		NOT_ON_ADC,    	/* 16,  port P2.3 */
		NOT_ON_ADC,    	/* 17,  port P2.4 */
		NOT_ON_ADC,    	/* 18,  port P2.5 */
		NOT_ON_ADC,   	/* 19,  port P3.5 */
		NOT_ON_ADC,   	/* 20,  port P3.6 */
		NOT_ON_ADC,  	/* 21,  port P3.7 */
		6,  	   		/* 22,  port P1.6 */
		7,     	   		/* 23,  port P1.7 */
		NOT_ON_ADC, 	/* 24, RST */
		NOT_ON_ADC, 	/* 25, TEST */
